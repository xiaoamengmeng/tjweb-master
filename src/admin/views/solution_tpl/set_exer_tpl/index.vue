    ...
    <div class="card" style="margin-top: 0;">
      <div class="list-title">
        ...
        <el-input
          v-model="tplTitle"
          class="mb_20"
          placeholder="输入运动方案标题"
          :readonly="type === 'view'"
          style="width: 450px; margin-left: 10px;"
        ></el-input>
      </div>
      <m-editor ref="editor" class="editor-box" :content.sync="content" mode="default"
                :disabled="type === 'view'"></m-editor>
      <div class="mt_20">
...
const localSession = new LocalStore('setExerTpl', true)
...
export default {
  ...
  methods: {
    ...
    update() {
      this.$api.exerTpl.update(this.tplId, {
        name: this.tplTitle,
        content: this.content
      })
        .then((res) => {
