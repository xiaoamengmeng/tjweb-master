              ...
              <el-radio label="不通过">不通过</el-radio>
				...
				<el-row v-if="form.result === '不通过'">
				  <el-form-item label="不通过原由" prop="reject_reason">
				    <el-input type="textarea" v-model="form.reject_reason" rows="4" clearable placeholder="" maxlength="50" style="width: 750px;"></el-input>
				  </el-form-item>
				</el-row>
...
const dishSession = new LocalStore('ExamineDetail', true)
