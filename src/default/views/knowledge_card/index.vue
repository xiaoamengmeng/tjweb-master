<template>
  <div class="panel">
    ...
    <m-button v-auth="'nutrKnowledgeCard.templateLibrary'" class="common-add-btn" icon="el-icon-data-board" @click="toLibrary" style="right: 298px;">知识卡模板库
    </m-button>
    <m-button v-auth="'nutrKnowledgeCard.templateCreate'" class="common-add-btn" icon="el-icon-brush" @click="creationClick" style="right: 158px;">按模板创作
    </m-button>
    <m-button v-auth="'nutrKnowledgeCard.uploadImg'" class="common-add-btn" icon="el-icon-upload2" @click="uploadImageCard">上传图片</m-button>
    <div class="card">
      <div class="container">
          ...
          <el-table-column label="操作" align="center" width="120px">
            <template v-slot="scope">
              <div class="flex justify_center">
                <icon-box v-auth="'nutrKnowledgeCard.update'" v-if="scope.row.extra && scope.row.extra.custom" icon-name="table_edit" w="39" h="39"
                ...
                <icon-box v-auth="'nutrKnowledgeCard.update'" v-else icon-name="table_edit" w="39" h="39"
                          box-w="39" style="cursor:pointer;"
                          title="编辑"
                          @click.native="editImageKcardClick(scope.row)"></icon-box>
                <icon-box v-auth="'nutrKnowledgeCard.delete'" icon-name="table_delete" w="39" h="39" box-w="39" style="cursor:pointer;" title="删除"
