...
export default {
  data() {
    return {
      ...
      weightHistoryRadio: "睡眠",
      todayWeightRecord: {},
      todayWeightRecordTable: [],

      todayWeight: "", // 今日睡眠
      todayInitWeight: "", // 初始睡眠
      todayTargetWeight: "", // 目标睡眠
