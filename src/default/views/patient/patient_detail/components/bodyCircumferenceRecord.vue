  ...
  <div class="blood-pressure-record-container">
    <div class="treat-result-view">
        ...
        <div class="box box-right">
          <div style="margin-bottom: 20px">
            ...
            >
              ...
              <el-radio-button label="大腿围"></el-radio-button>
              <el-radio-button label="颈围"></el-radio-button>
            </el-radio-group>
          </div>
          <template>
            <div class="mb_20">
      ...
      <div class="history-table mt_20">
        ...
        >
          <el-table-column label="测量时间" align="center" min-width="120">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <m-button type="default" @click="todayWeightRecordDialogVisible = false"
          >关 闭</m-button
        >
...
<script>
import bodyCircumferenceMixin from "../bodyCircumferenceMixin";
import calendar from "./calendar.vue";
import { mapGetters } from "vuex";
export default {
  mixins: [bodyCircumferenceMixin],
  components: {
    calendar,
  },
  props: ["ppInfo"],
