        ...
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <el-form-item
              ...
              required
            >
                <el-select style="width: 100%" clearable v-model="time_period" placeholder="请选择测量时段">
...
<script>
import bloodSugarMixin from "../bloodSugarMixin";
import calendar from "./calendar.vue";
import { mapGetters } from "vuex";
const list = [
  { name: "起床空腹", value: "empty_stomach", checked: false },
  { name: "早餐前", value: "before_breakfast", checked: false },
  { name: "早餐后", value: "after_breakfast", checked: false },
  { name: "午餐前", value: "before_lunch", checked: false },
  { name: "午餐后", value: "after_lunch", checked: false },
  { name: "晚餐前", value: "before_dinner", checked: false },
  { name: "晚餐后", value: "after_dinner", checked: false },
  { name: "入睡前", value: "before_sleep", checked: false },
];
export default {
  mixins: [bloodSugarMixin],
  components: {
    calendar,
  },
  props: ["ppInfo"],
  ...
  methods: {
    getInfo(type) {
      const item = this.list.find((ele) => ele.value == type);
