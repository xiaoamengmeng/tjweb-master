...
export default {
  data() {
    return {
      ...
      weightHistoryRadio: "腰围",
      todayWeightRecord: {},
      todayWeightRecordTable: [],

      todayWeight: "", // 今日腰围
      todayInitWeight: "", // 初始腰围
      todayTargetWeight: "", // 目标腰围
  ...
  methods: {
    ...
    getBloodPressureRecords() {
      ...
      this.$api.bodyCircumferenceRecords
        .getList({
          patient: this.patient.user_id,
    ...
    saveTodayWeight() {
      ...
      const params = {
        ...
        bustline: this.bustline,
        thighline: this.thighline,
    ...
    bodyChange() {
      switch (this.bodyRadio) {
        case "腰围":
          this.weightChartOptions.legend.data[0] = "腰围";
          this.weightChartOptions.legend.selected = {
            腰围: true,
          };
          this.weightChartOptions.yAxis[0].name = "腰围";
          this.weightChartOptions.series[0].name = "腰围";
          break;
        case "臀围":
          this.weightChartOptions.legend.data[0] = "臀围";
          this.weightChartOptions.legend.selected = {
            臀围: true,
          };
          this.weightChartOptions.yAxis[0].name = "臀围";
          this.weightChartOptions.series[0].name = "臀围";
          break;
        case "胸围":
          this.weightChartOptions.legend.data[0] = "胸围";
          this.weightChartOptions.legend.selected = {
            胸围: true,
          };
          this.weightChartOptions.yAxis[0].name = "胸围";
          this.weightChartOptions.series[0].name = "胸围";
          break;
        case "大腿围":
          this.weightChartOptions.legend.data[0] = "大腿围";
          this.weightChartOptions.legend.selected = {
            大腿围: true,
          };
          this.weightChartOptions.yAxis[0].name = "大腿围";
          this.weightChartOptions.series[0].name = "大腿围";
          break;
        case "颈围":
          this.weightChartOptions.legend.data[0] = "颈围";
          this.weightChartOptions.legend.selected = {
            颈围: true,
          };
          this.weightChartOptions.yAxis[0].name = "颈围";
          this.weightChartOptions.series[0].name = "颈围";
          break;
      }
      this.renderWeightChart();
    },
          ...
          this.weightChartOptions.xAxis[0].data.forEach((item, index) => {
            weightStats.forEach((stat) => {
              ...
              if (statDate === item) {
                switch (this.bodyRadio) {
                  case "腰围":
                    this.weightChartOptions.series[0].data[index] =
                      stat.waistline;
                    break;
                  case "臀围":
                    this.weightChartOptions.series[0].data[index] =
