<template>
  <div class="panel">
    ...
    <div class="card">
      <div class="container">
        <m-button v-auth="'nutrFoodCalorie.create'" class="common-add-btn" icon="el-icon-plus" @click="toSetPage('create')">添加</m-button>
          ...
          <div class="search-bar">
            <el-row class="search-bar-row" type="flex" justify="start" align="middle"
              ...
              <el-col class="search-bar-col" :span="7">
                ...
                <el-row>
                  <m-button icon="el-icon-search" h="40px" w="100px" @click="page=1;getFoodList()">搜索</m-button>
                </el-row>
              </el-col>
            </el-row>
          </div>
          ...
          <el-table-column label="操作" align="center" width="160px">
            <template v-slot="scope">
              <div class="flex justify_center">
                <icon-box v-auth="'nutrFoodCalorie.info'" icon-name="table_view" w="39" h="39" box-w="39" style="cursor:pointer;"
                          title="查看详情" @click.native="toSetPage('view', scope.row)"></icon-box>
                <icon-box v-auth="'nutrFoodCalorie.update'" icon-name="table_edit" w="39" h="39" box-w="39" style="cursor:pointer;"
                          title="编辑" @click.native="toSetPage('edit', scope.row)"></icon-box>
                <icon-box v-auth="'nutrFoodCalorie.delete'" icon-name="table_delete" w="39" h="39" box-w="39" style="cursor:pointer;" title="删除"
