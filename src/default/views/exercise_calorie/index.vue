<template>
  <div class="panel">
    ...
    <m-button v-auth="'nutrExerciseCalorie.create'" v-if="viewsMode === '运动库'" class="common-add-btn" icon="el-icon-plus" @click="toSetExercisePage">添加
    </m-button>
    <div class="card">
      <div class="container">
                  ...
                  <el-row>
                    <el-form-item prop="stage">
                      <el-input
                        ...
                        clearable
                        @keydown.enter.p.prevent="page=1;getList()"
                      ></el-input>
                    </el-form-item>
                  </el-row>
                </el-col>
            ...
            <el-table-column label="操作" align="center" width="120px">
              <template v-slot="scope">
                <div class="flex justify_center">
                  <icon-box v-auth="'nutrExerciseCalorie.update'" icon-name="table_edit" w="39" h="39" box-w="39" style="cursor:pointer;"
                            title="编辑" @click.native="toSetPage(scope.row)"></icon-box>
                  <icon-box v-auth="'nutrExerciseCalorie.delete'" icon-name="table_delete" w="39" h="39" box-w="39" style="cursor:pointer;" title="删除"
