            ...
            <el-table-column label="操作" align="center" width="120px">
              <template v-slot="scope">
                <div class="flex justify_center">
                  ...
                  <icon-box v-auth="'content.check'" v-if="scope.row.verify_state == 'pending'" icon-name="table_check" w="39" h="39" box-w="39" style="cursor: pointer" title="审核" @click.native="checkClick(scope.row)"></icon-box>
                </div>
              </template>
            </el-table-column>
          </m-table>
